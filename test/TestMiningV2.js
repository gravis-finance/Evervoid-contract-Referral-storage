...
describe("Test Mining", function () {
    ...
    it("Staking with correct equipment works", async function () {
        ...
        const stake = await mining.stakes(100001);
        expect(
            stake.grvxReward
        ...
        const [contracts, typeIds] = await mining.stakedEquipment(100001);
    ...
    it("Stakes getter is correct", async function () {
        ...
        expect(stakes[0].id).to.equal(100002);
        expect(stakes[0].owner).to.equal(owner.address);
